...
export default options => {
  ...
  return entity => {
    ...
    // size must be saved as it will be wiped out by some filters
    let size
    ...
    if (simplify) {
      if (entity.type) {
        ...
        // A type is required by simplifyEntity, but might have been omitted above
        entity = simplifyEntity({ type, ...entity }, simplifyOptions)
        delete entity.type
      }
    }
